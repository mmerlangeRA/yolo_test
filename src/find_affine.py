...
initial_params_array = [
    ...
    np.array([0.9/factorR,0.0, 0.2, 0.0, 0.9/factorR, 0.]),
    np.array([0.9/factorR,0.0, 0., 0.2, 0.9/factorR, 0.]),
    np.array([0.9/factorR,0.0, 0., 0.2, 0.9/factorR, 0.]),
    np.array([1/factorR,0.0, 0.1, 0.2, 1./factorR, 0.]),
    np.array([1.1/factorR,0.0, 0.1, 0.2, 1.1/factorR, 0.]),
]
